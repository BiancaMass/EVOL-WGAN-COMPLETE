...
"""For calculating EMD of a model"""
...
fake_images_base_dir = "/Volumes/SANDISK32_2/weight_experiments_at_the_end/weight_generated_lhs/"

fake_subfolders = [name for name in os.listdir(fake_images_base_dir) if
                   os.path.isdir(os.path.join(fake_images_base_dir, name))]
