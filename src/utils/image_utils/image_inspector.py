...
l_02_image_folder = '/Volumes/SANDISK32_2/benchmarking/fid_test/F_04_L2/F_04_L2_20'
l_03_image_folder = '/Volumes/SANDISK32_2/benchmarking/fid_test/F_04_L3/F_04_L3_20'
...
l_02_images = load_images_from_folder(l_02_image_folder)
l_03_images = load_images_from_folder(l_03_image_folder)

# Plot histograms in a grid
fig, axes = plt.subplots(2, 3, figsize=(15, 10))

plot_histogram(real_images, 'REAL Image Histogram', axes[0, 0])
plot_histogram(pqwgan_images, 'PQWGAN Image Histogram', axes[0, 1])
plot_histogram(classic_images, 'Classic Image Histogram', axes[0, 2])
plot_histogram(l_02_images, 'L02 Image Histogram', axes[1, 0])
plot_histogram(l_03_images, 'L03 Image Histogram', axes[1, 1])
